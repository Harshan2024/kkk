...
def calculate_emissions(weight_kg: float, factor: float) -> float:
    """Computes waste carbon emissions rounded to 2 decimal places using ROUND_HALF_UP."""
...
def calculate_waste_co2(weight_kg: float, factor: float, source: str) -> dict:
    """Computes waste carbon emissions and returns unified formula output schema."""
